...
([GitHub link](https://github.com/jonlin14/cdpdev/tree/main/.github)),
and then to the `workflows` sub-directory
([GitHub link](https://github.com/jonlin14/cdpdev/tree/main/.github/workflows)).
...
([GitHub link](https://github.com/jonlin14/cdpdev/tree/main/.github/workflows/event-gather-pipeline.yml)).
...
([GitHub link](https://github.com/jonlin14/cdpdev/tree/main/.github/workflows/event-index-pipeline.yml)).
