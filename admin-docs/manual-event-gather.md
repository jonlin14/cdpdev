...
[Event Gather GitHub Action Page](https://github.com/jonlin14/cdpdev/actions/workflows/event-gather-pipeline.yml).
...
[Process Special Event GitHub Action Page](https://github.com/jonlin14/cdpdev/actions/workflows/process-special-event.yml).
